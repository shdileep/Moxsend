    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="space-y-4 mb-6">
          <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Subject Lines</h4>
        ...
        <div className="space-y-3 mb-6">
          <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Opening Hooks</h4>
          <div className="space-y-2">
            {(email.openingLines || []).map((line, i) => (
              <div key={i} className="text-xs p-2 bg-brand-primary/5 border border-brand-primary/10 rounded-lg text-slate-400 italic">
                "{line}"
              </div>
            ))}
          </div>
        ...
        <div className="bg-slate-950/50 rounded-xl border border-slate-800 p-5 mb-6">
          <h4 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Email Body</h4>
